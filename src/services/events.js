...
export function recordSearch({ query = '', category = 'all', resultCount = 0, locationIds = [], bounds = null } = {}) {
  return record('search', {
    featureCode: 'location_search',
    valueNumeric: resultCount,
    valueText: query.trim() || category,
    metadata: { category, result_count: resultCount, result_location_ids: locationIds.slice(0, 25), bounds },
  }).catch(() => null);
}
