...
export default function CanonicalAppRuntime(){const location=useLocation();if(location.pathname==='/map')return <MapWorkspace/>;if(location.pathname==='/route')return <RoutePlannerPage/>;if(location.pathname==='/capabilities')return <CapabilityCenterPage/>;if(location.pathname==='/fleet-operations')return <FleetOperationsPage/>;return <Suspense fallback={<LegacyRuntimeFallback/>}><LegacyAppRuntime/></Suspense>}
