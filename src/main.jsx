...
function Startup(){try{assertRuntimeConfig();return <><App/><FeatureIntegration/></>}catch(error){return <main className="page"><div className="empty-state"><h1>Kleenest is not configured</h1><p>{error.message}</p><p>Add the required production environment variables and reload the application.</p></div></main>}}
